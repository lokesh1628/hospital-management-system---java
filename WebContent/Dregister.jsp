...
<tr><td>Picture:</td><td><input type="file" id="myfile" name="myfile1" required></td></tr>
<tr><td>Specialization:</td><td><input type="text" name="spl" required></td></tr>
<tr><td>Certificate:</td><td><input type="file" id="myfile" name="myfile" required></td></tr>
